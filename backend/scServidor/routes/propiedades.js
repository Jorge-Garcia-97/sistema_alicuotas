  ...
  try {
    ...
    getConnection(function (err, conn) {
      if (err) {
        ...
        const query = `INSERT INTO propiedad ( numero_casa, direccion_propiedad, propietario_id_propietario) VALUES ( '${data.numero_casa}', '${data.direccion_propiedad}', '${data.propietario_id_propietario}')`;
  ...
  try {
    ...
    getConnection(function (err, conn) {
      if (err) {
        ...
        const query = `UPDATE propiedad SET numero_casa = '${data.numero_casa}', direccion_propiedad = '${data.direccion_propiedad}', propietario_id_propietario = '${data.propietario_id_propietario}' WHERE id_propiedad = ?`;
